...
addLayer("a", {
    ...
    achievements: {
        ...
        47: { name: "Not implemented", tooltip: "Get Gamma milestone 7"          , done() { return hasMilestone("gamma", 6)                                                               }, style() { return componentBorderRadius(this.layer, "achievements", this.id, 8, 7) }, unlocked() { return hasAchievement(this.layer, 46) || tmp.a.achievements[51].unlocked   } },
